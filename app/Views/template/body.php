                        ...
                        <?php foreach ($dataBaju as $Baju) { ?>
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img class="card-img-top" src="<?= base_url() . '/assets/images/' . $Baju['baju_img'] ?>" alt="">
                                </figure>
                                <div class="block-4-text p-4">
                                    <h3><a href="#"><?= $Baju['baju_title'] ?></a></h3>
                                    <p class="mb-0"><?= $Baju['baju_description'] ?></p>
                                    <p class="text-primary font-weight-bold"><?= $Baju['baju_harga'] ?></p>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
